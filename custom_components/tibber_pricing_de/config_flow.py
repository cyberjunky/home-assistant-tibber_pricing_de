...
from .const import CONST_POSTALCODE


class TibberPricingConfigFlow(config_entries.ConfigFlow, domain="tibber_pricing_de"):
    VERSION = 1
    ...
    async def async_step_user(self, user_input=None):
        ...
        postalcode = user_input[CONST_POSTALCODE]
